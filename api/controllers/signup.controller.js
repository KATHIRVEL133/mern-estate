...
export const google = async (req,res,next)=>
{
    ...
    else
    {
        ...
        const newUser  = new User({username:req.body.name.split(" ").join("")+Math.random().toString(36).slice(-8),email:req.body.email,password:hasedPassword,avatar:req.body.photo});
        await newUser.save();
